...
// On iOS, prefer FullWindowOverlay for proper z-index; gracefully fallback if it's undefined
// Prefer FullWindowOverlay on iOS for correct layering above native headers; fallback to Fragment otherwise
const FullWindowOverlay =
  Platform.OS === 'ios' && (RNFullWindowOverlay as unknown as React.ComponentType | undefined)
...
function DropdownMenuContent({
  ...
  return (
    <DropdownMenuPrimitive.Portal hostName={portalHost ?? 'root'}>
      <FullWindowOverlay>
          ...
          <NativeOnlyAnimatedView entering={FadeIn}>
            <TextClassContext.Provider value="text-popover-foreground">
              <DropdownMenuPrimitive.Content
                className={cn(
                  'bg-popover border-border min-w-[8rem] overflow-hidden rounded-md border p-1 shadow-lg shadow-black/5 z-50',
                  Platform.select({
                    web: cn(
