...
<main class="mx-auto flex flex-col items-center text-center flex-grow">
	...
	<div class="mt-20 md:mt-40 flex flex-col items-center gap-8 px-6">
		...
		<a
			...
			class="h-14 w-48 flex items-center justify-center rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 text-white text-sm font-medium gap-2 transition-transform duration-300 hover:scale-102 {platform !== 'desktop' ? 'order-2' : ''}"
		>
		...
		<div class="flex flex-col sm:flex-row items-center justify-center gap-4 {platform !== 'desktop' ? 'order-1' : ''}">
			<!-- Apple App Store -->
			<a href="https://apps.apple.com/de/app/trainaa/id6758528495" target="_blank" rel="noopener noreferrer" class="h-14 w-48 relative flex items-center justify-center transition-transform duration-300 hover:scale-102 {platform === 'android' ? 'order-2 sm:order-2' : 'order-1 sm:order-1'}">
				{#if !appleLoaded}
					<span class="flex items-center justify-center h-14 w-full rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 text-white text-sm font-medium gap-2">
				...
				<img
					...
					class="h-14 w-full object-contain {appleLoaded ? '' : 'absolute inset-0 opacity-0'}"
					loading="eager"
					fetchpriority="high"
			...
			<!-- Google Play Store -->
			<a href="https://play.google.com/store/apps/details?id=com.pacerchat.app" target="_blank" rel="noopener noreferrer" class="h-14 w-48 relative flex items-center justify-center transition-transform duration-300 hover:scale-102 {platform === 'android' ? 'order-1 sm:order-1' : 'order-2 sm:order-2'}">
				{#if !googleLoaded}
					<span class="flex items-center justify-center h-14 w-full rounded-lg bg-white/10 backdrop-blur-sm border border-white/20 text-white text-sm font-medium gap-2">
				...
				<img
					...
					class="h-14 w-full object-contain {googleLoaded ? '' : 'absolute inset-0 opacity-0'}"
					loading="eager"
					fetchpriority="high"
